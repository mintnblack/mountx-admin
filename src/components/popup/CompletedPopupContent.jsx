...
function CompletedPopupContent(props) {
  ...
  const completedAppointment = () => {
    axios.put(`${BASE_URL}/appointment/update/${appointmentId}`, {
  ...
  return (
    <div>
      <DialogTitle id="alert-dialog-title">{"Appointment Completed"}</DialogTitle>
      <DialogContent>
        <DialogContentText id="alert-dialog-description">
          {"Indicate the appointment as completed?"}
        </DialogContentText>
      </DialogContent>
